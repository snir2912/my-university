...
class htmlUms {
    ...
    static public function defaultNonceForAdminPanel() {
		return self::hidden('_wpnonce', array('value' => wp_create_nonce('ums_nonce')));
	}
    static public function defaultNonceForFront() {
		return self::hidden('_wpnonce', array('value' => wp_create_nonce('ums_nonce_frontend')));
	}
