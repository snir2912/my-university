...
class supsystic_promoUms extends moduleUms {
	...
	public function getLoveLink($show = 'hide') {
		...
		if ($show == 'show') {
			return '<a title="' . $title . '" style="border:none; color: #26bfc1 !important; font-size: 9px; display: block; float: right; padding-right: 10px;" href="https://supsystic.com/plugins/google-maps-plugin/?utm_medium=love_link_hide" target="_blank">' . $title . '</a>' . '<div style="clear: both;"></div>';
		} else if ($show == 'hide') {
